...
def main() -> None:
    ...
    @mcp.tool()
    def run_semgrep(code_root: str, max_files: int | None = 20000, scan_id: str | None = None,
                    include_test_findings: bool = False) -> dict:
    ...
    @mcp.tool()
    def run_bandit(code_root: str, max_files: int | None = 20000, scan_id: str | None = None,
                   include_test_findings: bool = False) -> dict:
    ...
    @mcp.tool()
    def run_gitleaks(code_root: str, max_files: int | None = 20000, scan_id: str | None = None,
                     include_test_findings: bool = False) -> dict:
    ...
    @mcp.tool()
    def run_trivy(code_root: str, max_files: int | None = 20000, scan_id: str | None = None,
                  include_test_findings: bool = False) -> dict:
    ...
    @mcp.tool()
    def run_custom_rules(code_root: str, max_files: int | None = 20000, scan_id: str | None = None,
                         include_test_findings: bool = False) -> dict:
